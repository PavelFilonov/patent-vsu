...
import static com.vsu.patent.entity.enums.ProgramEntityType.INTEGRATED_CIRCUIT;
...
@Service
public class IntegratedCircuitReadService extends VersionAwareResponseService<ProgramDTO, Program> {

	@Autowired
	private ProgramHelper programHelper;

	public IntegratedCircuitReadService() {
	...
	protected Specification<Program> getSpecification(BusinessComponent bc) {
		return where(super.getSpecification(bc))
				...
				.and(isAvailableByEntityTypeSpecification(INTEGRATED_CIRCUIT))
	...
	public Actions<ProgramDTO> getActions() {
		return programHelper.buildReadActions(integratedCircuitEdit, integratedCircuitRead);
	}
