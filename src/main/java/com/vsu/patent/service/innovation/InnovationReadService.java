...
import static com.vsu.patent.entity.enums.InnovationEntityType.INNOVATION;
...
@Service
public class InnovationReadService extends VersionAwareResponseService<InnovationDTO, Innovation> {
	
	@Autowired
	private InnovationHelper innovationHelper;

	public InnovationReadService() {
		super(InnovationDTO.class, Innovation.class, null, InnovationReadMeta.class);
	}
	...
	protected Specification<Innovation> getSpecification(BusinessComponent bc) {
		return where(super.getSpecification(bc))
				...
				.and(isAvailableByEntityTypeSpecification(INNOVATION))
	...
	@Override
	protected ActionResultDTO<InnovationDTO> doUpdateEntity(Innovation entity,
			InnovationDTO data, BusinessComponent bc) {
		return null;
	}

	@Override
	public Actions<InnovationDTO> getActions() {
		return innovationHelper.buildReadActions(innovationEdit, innovationRead);
	}
